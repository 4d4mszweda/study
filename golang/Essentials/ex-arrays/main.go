...
func main() {
	var newArray = [3]string{"Reading", "Coding", "Gaming"}
	fmt.Println(newArray)
	fmt.Println(newArray[0])

	var newArray2 = [2]string{newArray[1], newArray[2]}
	fmt.Println(newArray2)

	newSlice := newArray[0:2]
	fmt.Println(newSlice)

	newSlice2 := newArray[:2]
	fmt.Println(newSlice2)

	newSlice3 := newArray[1:3]
	fmt.Println(newSlice3)

	var courseGoals = []string{"Learn Go", "Build a project"}
	fmt.Println(courseGoals)

	courseGoals[1] = "Build a project with Go"
